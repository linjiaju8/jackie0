    ...
    render: function () {
        return (
            <form className="commentForm" onSubmit={this.handleSubmit}>
                <input type="text" ref="author" placeholder="输入您的昵称"/>
                <input type="text" ref="text" placeholder="输入评论..."/>
...
// 从服务器获取数据
ReactDOM.render(<CommentBox url="http://localhost:8080/showcase/react/comment"
